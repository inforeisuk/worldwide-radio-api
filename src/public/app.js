...
function renderStations(stations) {
  ...
  if (stations.length === 0) {
    const msg = state.activeTab === 'favorites' 
      ...
      ? t.emptyRecents || 'Nenhuma rádio ouvida recentemente.'
      : t.emptySearch || 'Nenhuma estação encontrada 📻. Tente ajustar os filtros.';

    elements.stationsGrid.innerHTML = `
      <div class="glass-card" style="grid-column: 1 / -1; text-align: center; padding: 40px;">
        <p style="font-size: 1.2rem; margin-bottom: 8px;">${t.emptyList || 'Lista Vazia'}</p>
